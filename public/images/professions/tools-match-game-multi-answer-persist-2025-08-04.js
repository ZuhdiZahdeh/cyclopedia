...
function initializeSidebarControls() {
  ...
  if (langSelect) {
    ...
    langSelect.onchange = () => {
  localStorage.setItem('tools-match-lang', langSelect.value);
  ...
  if (modeSelect) {
    ...
    modeSelect.onchange = () => {
  localStorage.setItem('tools-match-mode', modeSelect.value);
  loadToolsMatchGameContent();
};
  }
  ...
  localStorage.setItem('tools-match-voice', voiceSelect.value);
  loadToolsMatchGameContent();
};
  }
}
...
function getLang() {
  return localStorage.getItem("tools-match-lang") || "ar";
}
...
function getVoice() {
  return localStorage.getItem("tools-match-voice") || "boy";
}
  return document.getElementById("tools-match-voice-select")?.value || "boy";
}

function getMode() {
  return localStorage.getItem("tools-match-mode") || "image-text";
}
